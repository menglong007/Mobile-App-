...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val idForEdit = intent.getStringExtra("IDFOREDIT").orEmpty() // Default to empty string if null

        if (id.isNotEmpty()) {
            // Existing forum: show details and comments
            binding.apply {
                onUpdate.visibility = View.GONE
                onPost.visibility = View.GONE
            ...
            detailViewModel.apply {
                ...
                loadComment(id)
                if (userId != null) {
                    onLikeForumDisplay(id, userId)
                }
            }
        } else if (idForEdit.isNotEmpty()) {
            // Editing mode
            binding.apply {
                onPost.visibility = View.GONE
            ...
            binding.onUpdate.setOnClickListener {
                ...
                // Delay and navigate to MainMenuActivity
            ...
            binding.apply {
                onUpdate.visibility = View.GONE
                onPost.visibility = View.VISIBLE
                loadInputComment.visibility = View.GONE
                showLike.visibility = View.GONE
            }
        }
